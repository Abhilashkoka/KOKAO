...
export const AdminListAuditLogsQueryParams = zod.object({
  ...
  "action": zod.enum(['plan_change', 'superadmin_grant', 'superadmin_revoke', 'plan_edit', 'plan_create', 'plan_delete', 'notification_policy_change', 'credential_change', 'app_brand_change', 'email_settings_change', 'email_test_send']).optional().describe('Only return records of this action type.'),
...
export const AdminListAuditLogsResponse = zod.object({
  ...
  "id": zod.number(),
  "action": zod.enum(['plan_change', 'superadmin_grant', 'superadmin_revoke', 'plan_edit', 'plan_create', 'plan_delete', 'notification_policy_change', 'credential_change', 'app_brand_change', 'email_settings_change', 'email_test_send']).describe('The privileged action that was recorded.'),
...
export const AdminExportAuditLogsQueryParams = zod.object({
  "action": zod.enum(['plan_change', 'superadmin_grant', 'superadmin_revoke', 'plan_edit', 'plan_create', 'plan_delete', 'notification_policy_change', 'credential_change', 'app_brand_change', 'email_settings_change', 'email_test_send']).optional().describe('Only export records of this action type.'),
