...
export const gamificationClaimsTable = pgTable(
  "gamification_claims",
  {
    ...
    /**
     * Canonical reward amount in milli-credits. Legacy generation buckets
     * above stay for audit/history; new claims spend this value through the
     * credit account and never recreate the old buckets.
     */
 ...
 */
export const gamificationPlanSettingsTable = pgTable(
  "gamification_plan_settings",
  {
    ...
    progressMeterEnabled: boolean("progress_meter_enabled")
      .notNull()
      .default(true),
    /**
     ...
     */
    rewardMultiplierPercent: integer("reward_multiplier_percent")
      .notNull()
      .default(100),
    ...
    refereeCaptionCredits: integer("referee_caption_credits")
      .notNull()
      .default(5),
    ...
    referralMaxRedemptions: integer("referral_max_redemptions")
      .notNull()
      .default(25),
    /**
     * Explicit canonical reward overrides, keyed by stable reward identity:
...
export type GamificationPlanSettings =
  typeof gamificationPlanSettingsTable.$inferSelect;
