...
/**
 * Resilient mock for `@workspace/api-client-react` (mobile mirror of
 * artifacts/socialforge/src/test/apiClientMock.ts).
 *
 * Returns a Proxy module namespace: known overrides win, and every unknown
 * export gets a sensible default so new generated hooks never break existing
 * tests.
 *
