...
const NATIVE_SYNCHRONIZED_AUDIO_MODELS = new Set([
  ...
  `atlascloud/${ATLASCLOUD_WAN_30_T2V_MODEL}`,
  `atlascloud/${ATLASCLOUD_WAN_30_I2V_MODEL}`,
  `atlascloud/${ATLASCLOUD_WAN_30_REFERENCE_MODEL}`,
  `atlascloud/${ATLASCLOUD_WAN_30_PRIME_T2V_MODEL}`,
  `atlascloud/${ATLASCLOUD_WAN_30_PRIME_I2V_MODEL}`,
  `atlascloud/${ATLASCLOUD_WAN_30_PRIME_REFERENCE_MODEL}`,
