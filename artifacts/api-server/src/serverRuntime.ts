...
/**
 * This module is dynamically imported by index.ts only after the production
 * saved-rate data bootstrap has committed. Keep every app import and worker
 * start import here so module evaluation cannot start runtime timers before
 * that gate completes.
 */
