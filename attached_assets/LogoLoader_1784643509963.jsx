// LogoLoader — ripple (1d) and draw-on trace (1e) loading animations
// Usage: <LogoLoader variant="ripple" size={80} color="#6D42F0" />
//        <LogoLoader variant="trace" />
...
export default function LogoLoader({ variant = "ripple", size = 80, color = "#6D42F0" }) {
  const ring = {
    ...
    <>
      ...
      {variant === "trace" ? (
        <svg width={size} height={size} viewBox="0 0 100 100" role="status" aria-label="Loading"
          ...
          <circle cx="50" cy="50" r="36" fill="none" stroke={color} strokeWidth="20"
